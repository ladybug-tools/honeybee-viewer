...
TSG.toggleGroundHelper = function ( position = THR.controls.target, elevation = -0.1 ) {
	...
	if ( !THR.groundHelper ) {
		...
		const material = new THREE.MeshPhongMaterial( { color: 0x004400, opacity: 0.95, side: 2, transparent: true } );
